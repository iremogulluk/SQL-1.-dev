<--2) EKLENECEK HEDEF VERİ LİSTESİ //-->
...
SELECT * FROM books WHERE title COLLATE Latin1_General_CS_AS LIKE '%Zaman%';
<--(SQL Server’da LIKE varsayılan olarak büyük/küçük harf duyarsızdır.Yani ‘zaman’, ‘ZAMAN’ veya ‘Zaman’ hepsi bulunur. Eğer büyük/küçük harf duyarlı arama yapılmak istenirse COLLATE kullanılmalıdır.)-->
